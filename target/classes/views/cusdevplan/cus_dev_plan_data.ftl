            ...
            <form class="layui-form" >
                ...
                <div class="layui-form-item layui-row">
                    ...
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   lay-verify="phone" name="linkPhone" value="${(saleChance.linkPhone)!}" id="linkphone" readonly="readonly">
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="${ctx}/js/cusdevplan/CusDevPlanData.js"></script>
</body>
</html>